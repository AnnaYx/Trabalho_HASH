...
public class TabelaDoubleHash {
    private final Registro[] table;
    private int tamanho = 0;
    private long colisoes = 0;

    public TabelaDoubleHash(int capacidade) {
    ...
    public void ZerarColisoes() { colisoes = 0; }

    public void inserir(Registro r) {
        int k = r.getCodigoInt();
        int base = h1(k);
        int step = h2(k);
        int i = 0;
        while (i < table.length) {
            int pos = (base + i * step) % table.length;
            ...
            if (table[pos] == null) {
                ...
                if (table[pos].getCodigoInt() == r.getCodigoInt()) {
                    colisoes += i;
                    return;
                }
            }
